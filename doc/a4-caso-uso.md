**Pregunta: ¿Quién tiene acceso a cada caso de uso?**
...
| Listar directiva | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| Ver detalle de miembro de directiva | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| Registrar miembro de directiva | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
| Editar miembro de directiva | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
...
| Ver panel de totales recaudados y pendientes | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |
| Ver estado de ingresos y multas por padre | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |
| **Gestión de gastos** | | | | | | |
| Listar gastos | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |
...
|---|---|---|
| N1 | Administrador | Desarrollador con acceso de super usuario |
...
Límites claros de cada actor sobre cada caso de uso. No existe código. No existen pantallas.