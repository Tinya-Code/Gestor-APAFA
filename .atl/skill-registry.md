...
- /Users/alejandro/.gemini/antigravity-cli/skills
...
| `gentle-ai-bench` | Trigger: bench, journey, journeys, driven mode, gentle-ai-bench, journey corpus, j-numbers, bench axis. Author and verify gentle-ai bench journeys; go test ./bench never proves driven execution. | user | `/Users/alejandro/.config/opencode/skills/gentle-ai-bench/SKILL.md` |
...
| `issue-creation` | Create and triage GitHub issues from repository evidence. Trigger: issue creation, bug reports, feature requests, or issue approval. | user | `/Users/alejandro/.config/opencode/skills/issue-creation/SKILL.md` |
...
| `rdd-defect-workflow` | Trigger: RDD, receipt-driven development, review authority, receipt/lineage, correction/recovery, delivery gate/kill switch, bounded review defects. Guide work. | user | `/Users/alejandro/.config/opencode/skills/rdd-defect-workflow/SKILL.md` |
...
| `systemic-issue-triage` | Trigger: new issue, bug report, triage, backlog, issue flood, community report, root cause, dead-end, blocked user. Attack issues by root class, never one-by-one; fixes must shrink the system, not grow it. | user | `/Users/alejandro/.config/opencode/skills/systemic-issue-triage/SKILL.md` |
| `tinacms-work` | Trigger: tinacms, tina schemas, tina config, cms fields, visual editing, content modeling, tina i18n, tina collections. Work with TinaCMS schemas, config, and Astro integration. | user | `/Users/alejandro/.config/opencode/skills/tinacms-work/SKILL.md` |
